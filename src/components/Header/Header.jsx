      ...
      <div className='header__right'>
        <div className='header__search-box'>
          <label htmlFor='search-field'>
            <img src={searchIcon} className='header__search-icon' alt='Search icon' />
          </label>
          <input id='search-field' type='search' className='header__search-input' placeholder='Search for something' />
        </div>
        <a href='#Setting' className='header__btn header__btn--settings'>
        ...
        <a href='#Accounts' className='header__user-link'>
          <img src={avatarImage} alt='User avatar' className='header__user-img' />
        </a>
      </div>
    </header>
  );
